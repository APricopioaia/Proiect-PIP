...
video = cv2.VideoCapture("resources/fantana_portocalie.mp4")
...
if fire_pixels > 0.1*np.size(candidate_fire, 1)*np.size(candidate_fire, 0):
    print("fire detected")
